...
identify_disagreements.py calculates the difference between the abelian firing gate and the non-abelian LE of each of the deployments, input 49972deployments.csv output disagreements.txt 
...
3. Generate the 49972 deployments (based on the above 1000 6-vertices SCCs with 50 random WAR assignments per SCC) using burau.py result saved to 49972deployments.csv
